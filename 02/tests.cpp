...
int main() 
{
    ...
    */
    ...
    Parser myparser;
    myparser.set_start_callback(st);
    myparser.set_end_callback(st);
    myparser.set_string_callback(str);
    myparser.set_number_callback(num);    
    myparser(std::string("123 00012  -10  -aw -0  - \r -10a  abab \n 12ad  \t abc12 asg135ll \n 45a576   "));
    return 0;
}
